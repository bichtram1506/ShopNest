...
import { DiscountComponent } from './components/admin/discount/discount.component'; // Import DiscountComponent
...
@NgModule({
  declarations: [
    ...
    SearchComponent,
    LoginPageComponent,
    DiscountComponent, // Add DiscountComponent to declarations
